...
## 1. [Заголовки](https://github.com/sandino/Markdown-Cheatsheet#headers)
```
# H1
## H2
### H3
...
------
```
## 2. [Выделение](https://github.com/sandino/Markdown-Cheatsheet#emphasis)
```
...
```
## 3. [Списки](https://github.com/sandino/Markdown-Cheatsheet#lists)
```
...
## 4. [Ссылки](https://github.com/sandino/Markdown-Cheatsheet#links)
...
## 5.  [Изображения](https://github.com/sandino/Markdown-Cheatsheet#images)
...
## 6. [Подсветка кода и синтаксиса](https://github.com/sandino/Markdown-Cheatsheet#code)
...
## 7. [Таблицы](https://github.com/sandino/Markdown-Cheatsheet#tables)
...
1 | 2 | 3
```
## 8. [Цитаты](https://github.com/sandino/Markdown-Cheatsheet#blockquotes)
...
## 9. [Встроенный HTML](https://github.com/sandino/Markdown-Cheatsheet#html)
```<dl>
...
```
## 10. [Горизонтальная линия](https://github.com/sandino/Markdown-Cheatsheet#hr)
Три и более...
...
## 11. [Новая строка](https://github.com/sandino/Markdown-Cheatsheet#lines)
```
...
```
## 12. [Видео](https://github.com/sandino/Markdown-Cheatsheet#videos)
